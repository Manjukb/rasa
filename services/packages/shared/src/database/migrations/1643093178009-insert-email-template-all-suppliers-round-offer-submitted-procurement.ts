...
export class insertEmailTemplateAllSuppliersRoundOfferSubmittedProcurement1643093178009 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        template.id = '562867a49c224abe92a6a3cc5e77e655';
        template.organisation_id = null;
        template.template_type = TemplateType.AllSuppliersRoundOfferSubmittedProcurement;
        template.subject = 'All Suppliers Offer Submission for RFQ RefNo:{{rfq_number}}';
        template.message = `<!DOCTYPE html>
        <html lang="en">
          <head>
            <title>AllSuppliersRoundOfferSubmittedProcurement</title>
            ...
            <div role="article" lang="en" style="background-color: #167d7f; color: #2b2b2b; font-family: 'Avenir Next', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; font-size: 18px; font-weight: 400; line-height: 28px; margin: 0 auto; max-width: 600px; padding: 40px 20px 40px 20px;">
                ...
                <main>
                    <div style="background-color: ghostwhite; border-radius: 4px; padding: 24px 48px;">
                        ...
                        <p>
                            All suppliers who met the deadline to submit their bids for Round {{negotiation_round_no}} have submitted their bids RFQ Reference No: {{rfq_number}}. You can view the latest status of the negotiation from this link: <a href="{{link_to_rfq_negotiation_detail_table}}"><button style="background-color: #29a0b1;
                                color: white;
                                text-align: center;
