...
export class alterEmailTemplateUpdateRfqSupplierOfferSubmitted1643091406916 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        <html lang="en">
          <head>
            <title>RfqSupplierOfferSubmitted</title>
            ...
            <div role="article" lang="en" style="background-color: #167d7f; color: #2b2b2b; font-family: 'Avenir Next', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; font-size: 18px; font-weight: 400; line-height: 28px; margin: 0 auto; max-width: 600px; padding: 40px 20px 40px 20px;">
                ...
                <main>
                    <div style="background-color: ghostwhite; border-radius: 4px; padding: 24px 48px;">
                        ...
                        <p>
                            Thank you for your response. We have received and acknowledge your response to our RFQ Reference No: {{rfq_number}} that we have received on {{supplier_offer_submit_date}}.
                        </p>        
                        <p>
        ...
        if (checkTemplate) {
            await queryRunner.manager
                ...
                .set({ message: message })
                .where({ template_type: TemplateType.RFQSupplierOfferSubmitted })
                .execute();
        }
    }
