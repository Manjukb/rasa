...
export class insertEmailTemplateRfqNegotiationRoundCompleted1647861775736 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        const checkTemplate = await queryRunner.manager.findOne(EmailTemplate, {
            template_type: TemplateType.RFQRoundCompleted,
        });

        const template = new EmailTemplate();
        template.id = 'a15e98e7d59a49f5847dfd131d1ae4b8';
        template.organisation_id = null;
        template.template_type = TemplateType.RFQRoundCompleted;
        template.subject = 'Please submit your subsequent offer for RFQ RefNo:{{rfq_number}} by {{rfq_date}}';
        template.message = `<!DOCTYPE html>
        <html lang="en">
          <head>
            <title>RfqRoundComplete</title>
               ...
               <header>
                ...
                <main>
                    <div style="background-color: ghostwhite; border-radius: 4px; padding: 24px 48px;">
                        ...
                        <p>
                            Thank you for your ongoing relationship with our organisation. We have received your quotation for {{categories}}. Appreciate, if you could make the offer at "Bot Offer". We request you to provide us your
