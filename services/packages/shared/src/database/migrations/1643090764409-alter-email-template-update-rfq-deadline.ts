...
export class alterEmailTemplateUpdateRfqDeadline1643090764409 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        <html lang="en">
          <head>
            <title>RfqDeadlineApproaching</title>
               ...
               <header>
                ...
                <main>
                    <div style="background-color: ghostwhite; border-radius: 4px; padding: 24px 48px;">
                        ...
                        <p>
                            Thank you for your ongoing engagement. Please note that the deadline for you to provide your response to our ongoing RFQ negotiation is {{rfq_date}}. We will not accept any quotes that we receive in the system after that.
                        </p>
        ...
        if (checkTemplate) {
            await queryRunner.manager
                ...
                .set({ message: message })
                .where({ template_type: TemplateType.RFQDeadlineApproaching })
                .execute();
        }
    }
